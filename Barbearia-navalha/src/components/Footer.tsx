      ...
      <div className="container">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://wa.me/5511977518335" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp da Navalha Sampa" className="text-muted-foreground hover:text-primary transition-colors"><Phone size={20} /></a>
          </div>
        </div>
      </div>
    </footer>
